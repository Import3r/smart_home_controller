...
;testing.c,27 :: 		void main(){
;testing.c,28 :: 		EEPROM_Write(0x32, 49);  // ASCII values of password characters (zero starts at value 48)
	MOVLW      50
	MOVWF      FARG_EEPROM_Write_Address+0
	MOVLW      49
	MOVWF      FARG_EEPROM_Write_data_+0
	CALL       _EEPROM_Write+0
;testing.c,29 :: 		EEPROM_Write(0x33, 50);
	MOVLW      51
	MOVWF      FARG_EEPROM_Write_Address+0
	MOVLW      50
	MOVWF      FARG_EEPROM_Write_data_+0
	CALL       _EEPROM_Write+0
;testing.c,30 :: 		EEPROM_Write(0x34, 51);
	MOVLW      52
	MOVWF      FARG_EEPROM_Write_Address+0
	MOVLW      51
	MOVWF      FARG_EEPROM_Write_data_+0
	CALL       _EEPROM_Write+0
;testing.c,31 :: 		EEPROM_Write(0x35, 52);
	MOVLW      53
	MOVWF      FARG_EEPROM_Write_Address+0
	MOVLW      52
	MOVWF      FARG_EEPROM_Write_data_+0
	CALL       _EEPROM_Write+0
;testing.c,33 :: 		ADCON0 = 0x05;
	MOVLW      5
	MOVWF      ADCON0+0
;testing.c,34 :: 		ADCON1 = 0x00;
	CLRF       ADCON1+0
;testing.c,35 :: 		CMCON = 7;
	MOVLW      7
	MOVWF      CMCON+0
;testing.c,37 :: 		Trisa = 0x0F;
	MOVLW      15
	MOVWF      TRISA+0
;testing.c,39 :: 		UART1_Init(9615);
	MOVLW      51
	MOVWF      SPBRG+0
	BSF        TXSTA+0, 2
	CALL       _UART1_Init+0
;testing.c,40 :: 		delay_ms(50);
	MOVLW      130
	MOVWF      R12+0
	MOVLW      221
	MOVWF      R13+0
L_main0:
	...
	NOP
	NOP
;testing.c,41 :: 		ADC_init();
	CALL       _ADC_Init+0
;testing.c,42 :: 		Trisb = 0x0F;
	MOVLW      15
	MOVWF      TRISB+0
;testing.c,43 :: 		portb = 0x00;
	CLRF       PORTB+0
;testing.c,46 :: 		Keypad_Init();                           // Initialize Keypad
	CALL       _Keypad_Init+0
;testing.c,48 :: 		while(1){
L_main1:
;testing.c,50 :: 		if ((portb.b0 == 1) && (flag2.B0 == 1))
	BTFSS      PORTB+0, 0
	GOTO       L_main5
	BTFSS      _flag2+0, 0
	GOTO       L_main5
L__main53:
;testing.c,51 :: 		flag1.B0 = 1;  //flag1 |= 0x02;     //buzzer ON
	BSF        _flag1+0, 0
	GOTO       L_main6
L_main5:
;testing.c,52 :: 		else flag1.B0 = 0; //flag1 = flag1 & 0xFD;
	BCF        _flag1+0, 0
L_main6:
;testing.c,55 :: 		if ((portb.b0 == 1) && (flag2.B1 == 1))
	BTFSS      PORTB+0, 0
	GOTO       L_main9
	BTFSS      _flag2+0, 1
	GOTO       L_main9
L__main52:
;testing.c,56 :: 		flag1.B1 = 1;    //LED
	BSF        _flag1+0, 1
	GOTO       L_main10
L_main9:
;testing.c,57 :: 		else flag1.B1 = 0; //flag1 = flag1 & 0xF7;     //flag1 |= 0x08;
	BCF        _flag1+0, 1
L_main10:
;testing.c,60 :: 		ADCON0 = 0b00001001;
	MOVLW      9
	MOVWF      ADCON0+0
;testing.c,61 :: 		value2 = ADC_Read(1)*4.88;
	MOVLW      1
	...
	MOVF       R0+1, 0
	MOVWF      _value2+1
;testing.c,63 :: 		if ((value2>300) && (flag2.B2 == 1))
	MOVF       R0+1, 0
	SUBLW      1
	BTFSS      STATUS+0, 2
	GOTO       L__main55
...
L__main55:
	...
	GOTO       L_main13
L__main51:
;testing.c,64 :: 		flag1.B2 = 1;//flag1 = flag1 | 0x01;
	BSF        _flag1+0, 2
	GOTO       L_main14
L_main13:
